...
///
/// The payloads here are the real Graph responses for MJ0KP6EV (AB#4387) — a
...
public class DeviceRecordTests
{
    ...
    public void HealthyEnrolledDeviceIsNotOrphaned()
    {
        var state = new GraphService.DeviceRecordState
        {
            Serial = "MJ0KP6EV",
            Autopilot = Autopilot(),
            Intune = new IntuneDevice { Id = "dc12ac91-2f80-4d5c-b6c6-622d43a26c76", DeviceName = "ANIM-STD-04" },
            EntraDevices = [EntraDevice()]
        };
