using FleetMate.Core.Shared.Config;
using FleetMate.Core.Projects.Models;
using FleetMate.Core.Projects.Models;
using FleetMate.Core.Shared.Services;
using FleetMate.Core.Devices.Services;
using FleetMate.Core.Inventory.Services;
using FleetMate.Core.Tickets.Services;
using FleetMate.Core.Projects.Services;
using FleetMate.Core.Reporting.Services;
using Serilog;

namespace FleetMate.Core.Projects.Services.Tasks;
